...
It adds a draggable floating counter on each tracked site and a popup with:
...
- `host_permissions` for LinkedIn, YouTube, X/Twitter, Facebook, and Instagram: required to detect those pages and inject the on-page badge
